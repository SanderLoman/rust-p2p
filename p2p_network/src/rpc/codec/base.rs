...
// // use crate::rpc::protocol::OutboundRequest;
// // use crate::rpc::protocol::RPCCodedResponse;
...
// use super::InboundCodec;
// use super::OutboundCodec;
...
// pub struct BaseInboundCodec {
//     /// Inner codec for handling various encodings
//     inner: InboundCodec,
//     phantom: PhantomData<_>,
// }

// impl BaseInboundCodec {
//     pub fn new(codec: InboundCodec) -> Self {
//         BaseInboundCodec {
//             inner: codec,
//             phantom: PhantomData,
//         }
