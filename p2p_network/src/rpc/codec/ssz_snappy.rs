...
fn handle_rpc_response(
    ...
    match versioned_protocol {
        ...
        // SupportedProtocol::LightClientBootstrapV1 => Ok(info!(
        //     "Received LightClientBootstrap response, ignoring"
        // )),
        ...
        SupportedProtocol::BlocksByRangeV2 => Ok(Some(RPCResponse::BlocksByRange(Arc::new(
        ...
        SupportedProtocol::BlocksByRootV2 => Ok(Some(RPCResponse::BlocksByRoot(Arc::new(
            SignedBeaconBlock::from_ssz_bytes(decoded_buffer)?,
        )))),
        None => Err(RPCError::ErrorResponse(
            RPCResponseErrorCode::InvalidRequest,
