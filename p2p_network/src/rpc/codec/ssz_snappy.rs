...
//         )),
//         SupportedProtocol::BlocksByRangeV1 => Ok(Some(RPCResponse::BlocksByRange(Arc::new(test)))),
//         SupportedProtocol::BlocksByRootV1 => {
//             Ok(Some(RPCResponse::BlocksByRoot(Arc::new(test.clone()))))
//         }
//         SupportedProtocol::PingV1 => Ok(Some(RPCResponse::Pong(Ping {
//             data: u64::from_ssz_bytes(decoded_buffer)?,
//         }))),
//         SupportedProtocol::LightClientBootstrapV1 => {
//             Ok(Some(RPCResponse::LightClientBootstrap(test.clone())))
//         }
//         SupportedProtocol::BlocksByRangeV2 => match fork_name {
//             Some(ForkName::Altair) => Ok(Some(RPCResponse::BlocksByRange(Arc::new(test.clone())))),

//             Some(ForkName::Base) => Ok(Some(RPCResponse::BlocksByRange(Arc::new(test.clone())))),
//             Some(ForkName::Merge) => Ok(Some(RPCResponse::BlocksByRange(Arc::new(test.clone())))),
//             Some(ForkName::Capella) => {
//                 Ok(Some(RPCResponse::BlocksByRange(Arc::new(decoded_buffer))))
//             }
...
//             Some(ForkName::Altair) => Ok(Some(RPCResponse::BlocksByRoot(Arc::new(test.clone())))),
//             Some(ForkName::Base) => Ok(Some(RPCResponse::BlocksByRoot(Arc::new(test.clone())))),
//             Some(ForkName::Merge) => Ok(Some(RPCResponse::BlocksByRoot(Arc::new(test.clone())))),
//             Some(ForkName::Capella) => {
//                 Ok(Some(RPCResponse::BlocksByRoot(Arc::new(decoded_buffer))))
//             }
//             None => Err(RPCError::ErrorResponse(
//                 RPCResponseErrorCode::InvalidRequest,
//                 format!(
