...
use project_types::api_calls::get_block::Signature;
use ssz::Encode;
...
use project_types::api_calls::get_block::BeaconBlock;
use project_types::api_calls::get_block::SignedBeaconBlock;
use project_types::eth_spec::MainnetEthSpec;
use project_types::fork_context::{ForkContext, ForkName};
use project_types::{EthSpec, Hash256};
...
lazy_static! {
    ...
    + project_types::api_calls::get_block::ExecutionPayload::<MainnetEthSpec>::max_execution_payload_capella_size() // adding max size of execution payload (~16gb)
